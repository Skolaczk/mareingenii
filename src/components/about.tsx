        ...
        <div className="space-y-5 md:space-y-10 lg:space-y-20">
          <div className="space-y-5 md:flex md:justify-between md:gap-10 md:space-y-0">
            ...
            <p className="md:max-w-xl">
              Our core mission is to maintain the utmost standards of quality
              and transparency in our services. We are dedicated to perpetual
              growth and refinement, with the aim of consistently surpassing
              industry standards.
            </p>
          </div>
          ...
          <p className="md:max-w-xl">
            ...
            underscores our unfaltering dedication to effective positive change
            in both society and the global community.
          </p>
        </div>
        <div className="space-y-5 md:flex md:justify-between md:gap-10 md:space-y-0">
          ...
          <p className="md:max-w-xl">
            Our vision encompasses setting and reshaping industry standards
            while fostering innovation and collaboration with like-minded
            organizations. We are firmly dedicated to the pursuit of excellence,
            aspiring to be a driving force behind positive change and continuous
            innovation in the dynamic world of design and product strategy.
          </p>
        </div>
