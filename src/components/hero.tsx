import { CircleDot, InclinedLine } from '@/assets/shapes';

export const Hero = () => {
  return (
    <section className="container relative my-16 space-y-10 md:my-20 md:space-y-20 lg:my-40 lg:space-y-24">
      <CircleDot className="xs:size-80 xs:translate-y-[-60%] absolute top-1/2 size-64 -translate-y-2/3 md:translate-y-[-55%] lg:size-auto lg:-translate-y-1/2" />
