...
export const Hero = () => {
  return (
    <section className="container relative my-14 space-y-10 md:my-20 md:space-y-20 lg:my-40">
      ...
      <div className="space-y-10 md:flex md:items-center md:justify-between md:space-y-0 lg:justify-start lg:gap-14">
        <div className="flex items-center">
          <h3 className="xs:text-5xl font-serif text-4xl uppercase md:text-7xl lg:text-9xl">
            expertise
          </h3>
          <InclinedLine className="xs:size-10 mx-4 size-8 md:size-14 lg:ml-14 lg:mr-0 lg:size-20" />
        </div>
      ...
      <h3 className="xs:text-5xl text-right font-serif text-4xl uppercase md:text-7xl lg:text-9xl">
        transparency
      </h3>
      <div className="space-y-10 md:flex md:items-center md:justify-between md:space-y-0">
        ...
        <span className="xs:text-6xl mr-4 inline text-5xl font-thin md:text-8xl lg:text-9xl">
          &
        </span>
        <h3 className="xs:text-5xl inline font-serif text-4xl uppercase md:text-7xl lg:text-9xl">
          crafts
        </h3>
      </div>
    </section>
