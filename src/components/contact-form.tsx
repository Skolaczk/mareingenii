    ...
    <ModalTemplate close={close}>
      <div className="container flex h-[calc(100vh-64px)] flex-col items-center gap-10 py-10 lg:flex-row lg:items-center lg:gap-32">
        <div className="relative flex w-full flex-col gap-5 md:gap-10 lg:gap-20">
          ...
          <h3 className="xs:text-6xl font-serif text-5xl uppercase md:text-8xl lg:text-9xl">
            let&apos;s
          </h3>
          <h3 className="xs:text-6xl before:bg-secondary relative self-end font-serif text-5xl uppercase before:absolute before:-left-16 before:bottom-1.5 before:h-0.5 before:w-14 md:text-8xl lg:text-9xl">
            get in
          </h3>
          <h3 className="xs:text-6xl after:bg-secondary relative font-serif text-5xl uppercase after:absolute after:bottom-1.5 after:ml-4 after:size-4 after:rounded-full md:text-8xl md:after:bottom-2.5 md:after:size-6 lg:text-9xl lg:after:bottom-3 lg:after:ml-6 lg:after:size-8">
            touch
          </h3>
        </div>
